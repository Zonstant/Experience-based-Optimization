...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int t=1;t<=71;t++){
            ...
            interchangeADD(y,s,d,f,c);
            double ans3=drop(s,d,f,c);
            for(int j=0;j<n;j++){
                y[j]=1;
            }
            ...
            try {
                wr.write(t+"");
                wr.newLine();
                wr.write("time :"+((System.currentTimeMillis()-start)/1000));
                wr.newLine();
                wr.write("add :"+ans1);
                wr.newLine();
                wr.write("drop :"+ans3);
                wr.newLine();
                wr.write("interchangeDrop :"+ans4);
                wr.newLine();
                wr.flush();
            } catch (IOException e) {
                e.printStackTrace();
    ...
    public static void addWithLowerBound(double[] olds,double[] d,double[] oldf,double[][] oldc,double[] superCost){
        //lower bound: 只有循环的变了
        int n=olds.length+1;
        int m=d.length;
        ...
        while(true){
            ...
            for(int j=0;j<n;j++){
                ...
                double lbs=getLowerBound(k,s,d);
