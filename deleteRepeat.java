...
public class deleteRepeat{
    ...
    public static void main(String[] args){
        ...
        try {
            solution=new BufferedWriter(new FileWriter(new File("rupdate.txt")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ArrayList<String> files=new ArrayList<String>();
        try {
            for (File s:new File("small").listFiles()){
                if(s.getCanonicalPath().endsWith("S.txt"))
